...
if __name__ == "__main__":
    ...
    video_data_path = "data/video_data105.pt"  # Replace with the actual path to labels.pt
    video_data = torch.load(video_data_path, weights_only=True)
    labels_path = "data/labels105.pt"  # Replace with the actual path to labels.pt
    ...
    continuous_video_path = 'results/v1.mp4'
    black_continuous_output_path = 'results/v1-black.mp4'
    final_continuous_output_path = 'results/v1-greeborder.mp4'
